...
@mcp.tool(title="ActiveDocument-Name")
...
@mcp.tool(title="PartDocument-Properties")
...
@mcp.tool(title="Part-Properties")
...
@mcp.tool(title="Body-Properties")
...
@mcp.tool(title="Sketch-Properties")
...
@mcp.tool(title="Point2D-Properties")
...
@mcp.tool(title="Line2D-Properties")
...
@mcp.tool(title="Circle-Properties")                    
...
@mcp.tool(title="Pocket-Properties")
...
@mcp.tool(title="Shaft-Properties")
...
@mcp.tool(title="Groove-Properties")
...
@mcp.tool(title="enum_CatConstraintType")
...
@mcp.tool(title="enum_CatHoleType")
...
@mcp.tool(title="enum_CatHoleAnchorMode")
...
@mcp.tool(title="enum_CatHoleBottomType")
...
@mcp.tool(title="enum_CatLimitMode")
...
@mcp.tool(title="enum_CatHoleThreadingMode")
...
@mcp.tool(title="enum_CatHoleThreadSide")
...
@mcp.tool(title="enum_CatCSHoleMode")
